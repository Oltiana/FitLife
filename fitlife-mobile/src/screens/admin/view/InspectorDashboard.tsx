...
type Section = 'home' | 'yoga' | 'analytics';
...
export function InspectorDashboard({ onLogout }: { onLogout: () => void }) {
  ...
  const SidebarContent = () => (
    <View style={styles.sidebar}>
      <View style={styles.sidebarHeader}>
        <Ionicons name="cube-outline" size={28} color="#c9782e" />
        <Text style={styles.sidebarTitle}>FitLife</Text>
        <View style={styles.rolePill}>
          <Ionicons name="eye-outline" size={11} color="#c9782e" />
        ...
        {NAV_ITEMS.map(item => (
          ...
          >
            <Ionicons
              ...
              size={20}
              color={activeSection === item.id ? '#c9782e' : '#6b7a6b'}
            />
      ...
      <View style={styles.main}>
        <View style={styles.topBar}>
          <View style={styles.topBarLeft}>
            ...
            {activeSection !== 'home' && (
              <Pressable style={styles.backBtn} onPress={() => setActiveSection('home')}>
                <Ionicons name="arrow-back-outline" size={18} color="#c9782e" />
              </Pressable>
            )}
          ...
          <View style={styles.adminBadge}>
            <Ionicons name="eye-outline" size={14} color="#c9782e" />
            <Text style={styles.adminBadgeText}>Inspector</Text>
          </View>
        </View>
          ...
          {activeSection === 'home' && (
            <View style={{ gap: 16 }}>
              <View style={styles.welcomeBanner}>
                ...
                <Text style={styles.welcomeText}>Welcome, Inspector! Manage Yoga sessions and classes.</Text>
              </View>
              <Text style={styles.sectionHeading}>Quick Actions</Text>
              <View style={styles.actionsGrid}>
                <ActionCard icon="leaf-outline" label="Yoga" color="#c9782e" bg="#fff4e8" onPress={() => setActiveSection('yoga')} />
...
const styles = StyleSheet.create({
  ...
  rolePill: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 10, paddingVertical: 4, borderRadius: 999, backgroundColor: '#fff4e8' },
  rolePillText: { fontSize: 11, fontWeight: '700', color: '#c9782e' },
  ...
  navItemActive: { backgroundColor: '#fff4e8' },
  navLabel: { fontSize: 13, fontWeight: '600', color: '#6b7a6b' },
  navLabelActive: { color: '#c9782e', fontWeight: '700' },
  ...
  hamburger: { padding: 4 },
  backBtn: { padding: 4, backgroundColor: '#fff4e8', borderRadius: 8 },
  pageTitle: { fontSize: 20, fontWeight: '800', color: '#142210' },
  adminBadge: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 10, paddingVertical: 5, borderRadius: 999, backgroundColor: '#fff4e8' },
  adminBadgeText: { fontSize: 12, fontWeight: '700', color: '#c9782e' },
  content: { padding: 20, gap: 8 },
  welcomeBanner: { flexDirection: 'row', alignItems: 'center', gap: 8, padding: 12, borderRadius: 12, backgroundColor: '#fff4e8' },
  welcomeText: { fontSize: 13, fontWeight: '700', color: '#c9782e', flex: 1 },
