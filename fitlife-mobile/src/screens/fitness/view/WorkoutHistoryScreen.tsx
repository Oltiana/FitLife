...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: '#fff', borderRadius: 18, borderWidth: 1, borderColor: '#E2E2E2', padding: 12, marginBottom: 14, flexDirection: 'row', alignItems: 'center' },
  cardContent: { flex: 1 },
  sessionTitle: { color: '#5F8F64', fontSize: 16, fontWeight: '800' },
  sessionMeta: { color: '#777', fontSize: 13, fontWeight: '600', marginTop: 4 },
  badgeRow: { flexDirection: 'row', gap: 8, marginTop: 10 },
  badge: { backgroundColor: '#DCEADB', paddingHorizontal: 10, paddingVertical: 5, borderRadius: 6 },
  badgeText: { color: '#6F9B73', fontSize: 11, fontWeight: '800' },
  historyImageBox: { width: 86, height: 74, borderRadius: 16, overflow: 'hidden', backgroundColor: '#DCEADB', marginRight: 14 },
