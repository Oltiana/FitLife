...
export function ExerciseDetailScreen() {
  ...
  const handleAddToPlan = async () => {
    ...
    try {
      ...
      setShowModal(false);
      Alert.alert('Exercise added', 'This exercise was added to your workout plan.', [
        { text: 'Done', style: 'cancel' },
        { text: 'View Plan', onPress: () => navigation.navigate('WorkoutPlans') },
      ]);
    } catch (error) {
              ...
              <View style={styles.modalCard}>
                ...
                {plans.length === 0 ? (
                  <View style={styles.emptyPlanBox}>
                    ...
                    <Pressable style={styles.createPlanButton} onPress={() => { setShowModal(false); navigation.navigate('CreateWorkoutPlan'); }}>
...
const styles = StyleSheet.create({
  ...
  subtitle: { color: '#F1FFF2', marginTop: 6, fontWeight: '700', textTransform: 'capitalize' },
  content: { padding: 22, alignItems: 'center' },
  imageBox: { width: '100%', height: 240, borderRadius: 28, overflow: 'hidden', shadowColor: '#000', shadowOffset: { width: 0, height: 5 }, shadowOpacity: 0.12, shadowRadius: 10, elevation: 5, marginBottom: 22 },
  name: { fontSize: 24, fontWeight: '800', color: '#5F8F64', textAlign: 'center', textTransform: 'capitalize', marginBottom: 20 },
  infoCard: { width: '100%', backgroundColor: '#fff', borderRadius: 16, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#E2E2E2' },
  label: { color: '#7FAE83', fontSize: 13, fontWeight: '800', marginBottom: 4 },
  value: { color: '#333', fontSize: 16, fontWeight: '700', textTransform: 'capitalize' },
  button: { width: '100%', backgroundColor: '#86B587', paddingVertical: 15, borderRadius: 20, marginTop: 14, alignItems: 'center' },
  ...
  modalCard: { backgroundColor: '#F8FAF7', borderTopLeftRadius: 28, borderTopRightRadius: 28, padding: 22 },
  modalTitle: { color: '#5F8F64', fontSize: 21, fontWeight: '800', marginBottom: 16 },
  emptyText: { color: '#777', fontWeight: '600', marginBottom: 14 },
  planOption: { backgroundColor: '#fff', borderWidth: 1, borderColor: '#E2E2E2', borderRadius: 14, padding: 14, marginBottom: 10 },
  planOptionActive: { backgroundColor: '#86B587', borderColor: '#86B587' },
  planOptionText: { color: '#5F8F64', fontWeight: '800' },
  planOptionTextActive: { color: '#fff' },
  row: { flexDirection: 'row', gap: 12, marginTop: 8 },
  inputGroup: { flex: 1 },
  inputLabel: { color: '#5F8F64', fontWeight: '800', marginBottom: 6 },
  input: { backgroundColor: '#fff', borderWidth: 1, borderColor: '#E2E2E2', borderRadius: 14, paddingHorizontal: 14, paddingVertical: 12, fontSize: 15, color: '#333' },
  modalButton: { backgroundColor: '#86B587', paddingVertical: 15, borderRadius: 20, alignItems: 'center', marginTop: 20 },
  disabledButton: { opacity: 0.5 },
  modalButtonText: { color: '#fff', fontWeight: '800', fontSize: 15 },
  cancelButton: { alignItems: 'center', paddingVertical: 14 },
  cancelText: { color: '#777', fontWeight: '800' },
  favoriteButtonText: { color: '#5F8F64', fontWeight: '800', fontSize: 15 },
  favoriteMessage: { color: '#5F8F64', fontWeight: '700', marginTop: 8, marginBottom: 4 },
  heroImage: { width: '100%', height: '100%', resizeMode: 'cover' },
  badgeRow: { flexDirection: 'row', gap: 8, marginBottom: 18 },
  levelBadge: { backgroundColor: '#DCEADB', paddingHorizontal: 14, paddingVertical: 7, borderRadius: 10 },
  levelText: { color: '#5F8F64', fontSize: 12, fontWeight: '800' },
  bodyBadge: { backgroundColor: '#FFE1D0', paddingHorizontal: 14, paddingVertical: 7, borderRadius: 10 },
  bodyText: { color: '#D47A45', fontSize: 12, fontWeight: '800', textTransform: 'capitalize' },
  emptyPlanBox: { backgroundColor: '#FFFFFF', borderRadius: 18, padding: 18, alignItems: 'center', marginBottom: 16, borderWidth: 1, borderColor: '#E2E2E2' },
  emptyPlanTitle: { color: '#5F8F64', fontSize: 17, fontWeight: '900', marginTop: 10 },
  emptyPlanText: { color: '#777', fontSize: 13, fontWeight: '600', textAlign: 'center', marginTop: 6, lineHeight: 19 },
  createPlanButton: { backgroundColor: '#86B587', paddingHorizontal: 18, paddingVertical: 12, borderRadius: 18, marginTop: 14 },
  createPlanButtonText: { color: '#FFFFFF', fontWeight: '900' },
});